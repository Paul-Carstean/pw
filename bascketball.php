    ...
    <div class="wrapper">
        <div class="sidebar">
            <ul>
                ...
                <li><a style="background-color:black; color: white; text-decoration: blink;"  href="#"><i class="fas fa-basketball-ball"></i>  Bascketball</a></li>
                <li><a href="tennis.php"><i class="far fa-tennis-ball"></i>  Tennis</a></li>
